...
namespace Chat.Db.Migrations.Migrations
{
    ...
    [Migration("20220620162859_FixedNullableTypes")]
    partial class FixedNullableTypes
    {
            ...
            modelBuilder.Entity("Chat.Db.Models.AppIdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEJcHO5DqtIMsMj3646tWb/N6XKaFfOMasxuryr4eptla3rNCCyaRjJ9tON4yzHW/hg==",
            ...
            modelBuilder.Entity("Chat.Db.Models.Group", b =>
                {
                    ...
                    b.Property<DateTime>("RecCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2022, 6, 20, 16, 28, 58, 869, DateTimeKind.Utc).AddTicks(8202));

                    b.Property<DateTime>("RecModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2022, 6, 20, 16, 28, 58, 869, DateTimeKind.Utc).AddTicks(8370));
